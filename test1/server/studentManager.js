...
var getStudentMaggiore = function getStudentMaggiore(voto)
{
	var ret = new Array();
...
var getStudentMinore = function getStudentMinore(voto)
{
	var ret = new Array();
	for(var i=0;i<studentList.length;i++){
		if(studentList[i].mark<voto){
...
exports.getStudentMaggiore = getStudentMaggiore; 
exports.getStudentMinore = getStudentMinore; 
