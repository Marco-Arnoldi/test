...
app.post('/searchStudent', function(request, response) 
{
	...
	var studentID;https://github.com/DamianoBonani/SE2Lab_Exam_2016_12https://github.com/DamianoBonani/SE2Lab_Exam_2016_12
...
/**
 * @brief Resrtituisce una lista di studenti con un voto maggiore o minore a quello passato
 */
...
{	
    ...
    if(voto!="not defined" && voto!="body undefined"){
		...
		console.log(voto);
    	if(simbolo=="<"){
	    	studenti= studentManager.getStudentMinore(voto);
	    }
	   
	    if(simbolo==">"){
	    	studenti= studentManager.getStudentMaggiore(voto);
	    }
